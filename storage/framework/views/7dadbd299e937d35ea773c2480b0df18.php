    ...
    $('#inputNamaProduk, #inputMerkProduk').on('keyup', function() {
        ...
        if (nama.length >= 3 || merk.length >= 3) {
            $.ajax({
                ...
                url: "<?php echo e(route('admin.produk.search')); ?>", 
                method: "GET",
                data: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\asus\OneDrive\Documents\GitHub\kp_trenmart\sistemPenjualanTrenmart\resources\views\admin\edit_judul.blade.php ENDPATH**/ ?>